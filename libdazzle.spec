...
Source0  : https://download.gnome.org/sources/libdazzle/3.28/libdazzle-3.28.3.tar.xz
Summary  : No detailed summary available
Group    : Development/Tools
License  : GPL-3.0
Requires: libdazzle-bin
Requires: libdazzle-data
Requires: libdazzle-lib
Requires: libdazzle-license
...
export LANG=C
export SOURCE_DATE_EPOCH=1530083111
CFLAGS="$CFLAGS" CXXFLAGS="$CXXFLAGS" LDFLAGS="$LDFLAGS" meson --prefix /usr --buildtype=plain   builddir
ninja -v -C builddir

%install
mkdir -p %{buildroot}/usr/share/doc/libdazzle
cp COPYING %{buildroot}/usr/share/doc/libdazzle/COPYING
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/libdazzle/COPYING
