...
Source0  : https://download.gnome.org/sources/libdazzle/3.40/libdazzle-3.40.0.tar.xz
...
%prep
%setup -q -n libdazzle-3.40.0
cd %{_builddir}/libdazzle-3.40.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618930447
...
cp %{_builddir}/libdazzle-3.40.0/COPYING %{buildroot}/usr/share/package-licenses/libdazzle/338650eb7a42dd9bc1f1c6961420f2633b24932d
