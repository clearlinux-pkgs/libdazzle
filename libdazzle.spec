...
Source0  : https://download.gnome.org/sources/libdazzle/3.42/libdazzle-3.42.0.tar.xz
...
Requires: libdazzle-locales = %{version}-%{release}
...
%package locales
Summary: locales components for the libdazzle package.
Group: Default

%description locales
locales components for the libdazzle package.


%prep
%setup -q -n libdazzle-3.42.0
cd %{_builddir}/libdazzle-3.42.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631314389
...
cp %{_builddir}/libdazzle-3.42.0/COPYING %{buildroot}/usr/share/package-licenses/libdazzle/338650eb7a42dd9bc1f1c6961420f2633b24932d
...
/usr/include/libdazzle-1.0/suggestions/dzl-suggestion-button.h
...
/usr/share/package-licenses/libdazzle/338650eb7a42dd9bc1f1c6961420f2633b24932d

%files locales -f libdazzle-1.0.lang
%defattr(-,root,root,-)
